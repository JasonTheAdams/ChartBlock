...
const {BaseControl, PanelRow, IconButton, Button} = wp.components;
            ...
            <BaseControl label={label}>
                {
                    data.map((item, index) => (
                        <PanelRow>
                            ...
                            <IconButton onClick={this.removeRow.bind(null, index)} icon="minus" label="Remove"/>
                        </PanelRow>
                    ))
                }
                <Button onClick={this.addRow} isSmall>Add More</Button>
            </BaseControl>
        );
    }
}
